...
def generateFrame(image, sentence):
    save_path = str(random.randint(0, 1000000000000)) + ".png"
    text_img = generateText(sentence, save_path)
    ...
    black_bg.save("Images/Final/"+save_path)
    return "Images/Final/"+save_path
